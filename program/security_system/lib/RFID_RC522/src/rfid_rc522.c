...
#define SPI_MOSI GPIO_PIN_6 // SPI MISO
...
// void delay(long x); // It isn't used anywhere
/////////////////////////////
void RC522_Init(void)
{
  ...
  GPIO_Init(CHIP_SELECT_PORT, CHIP_SELECT_PIN, GPIO_MODE_OUT_PP_HIGH_SLOW);
  GPIO_WriteHigh(CHIP_SELECT_PORT, CHIP_SELECT_PIN); // CS
  // RST
  GPIO_Init(SPI_PORT, SPI_RST, GPIO_MODE_OUT_PP_HIGH_SLOW); // RST
...
{
  GPIO_Init(SPI_PORT, SPI_MISO, GPIO_MODE_IN_PU_NO_IT);      // MISO
  GPIO_Init(SPI_PORT, SPI_MOSI, GPIO_MODE_OUT_PP_HIGH_SLOW); // MOSI
  GPIO_Init(SPI_PORT, SPI_SCK, GPIO_MODE_OUT_PP_HIGH_SLOW);  // SCK
  ///
  GPIO_Init(CHIP_SELECT_PORT, CHIP_SELECT_PIN, GPIO_MODE_OUT_PP_HIGH_SLOW); // CS
  GPIO_WriteHigh(CHIP_SELECT_PORT, CHIP_SELECT_PIN);                        // CS
  // RST
  GPIO_Init(SPI_PORT, SPI_RST, GPIO_MODE_OUT_PP_HIGH_SLOW); // RST
  GPIO_WriteHigh(SPI_PORT, SPI_RST);                        // RST
}
////////////////////////////////////
/* void delay(long x)
{
