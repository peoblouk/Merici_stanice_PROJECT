...
#define SWI2C_SS_TIME delay.us(SWI2C_START_STOP_TIME)
#define SWI2C_SETUP_TIME delay.us(SWI2C_SDA_SETUP_TIME)
#define SWI2C_HOLD_TIME delay.us(SWI2C_SDA_HOLD_TIME)
#define SWI2C_SCL_HIGH_TIME delay.us(SWI2C_SCL_HALFPERIOD_TIME)
